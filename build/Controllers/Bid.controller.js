...
exports.getNBids = exports.getBids = exports.getBidById = exports.getAllBid = exports.updateBid = exports.deleteBid = exports.createBid = void 0;
...
exports.getNBids = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req.params.limit != "" && !isNaN(Number(req.params.limit))) {
        ...
        if (result) {
            ...
            return Response_custom_1.createResponse(res, "Bid not found", undefined, 404);
        }
    }
    else {
